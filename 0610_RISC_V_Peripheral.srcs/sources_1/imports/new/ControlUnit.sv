...
module ControlUnit (
  ...
  always_comb begin : main_decoder
    case (op) 
      ...
      `OP_TYPE_S:  countrols = 11'b0_1_00_1_001_0_0_0;
      `OP_TYPE_B:  countrols = 11'b0_0_00_0_010_1_0_0;
      `OP_TYPE_U:  countrols = 11'b1_0_10_0_011_0_0_0;
      `OP_TYPE_UA: countrols = 11'b1_0_11_0_011_0_0_0;
      `OP_TYPE_J:  countrols = 11'b1_0_11_0_100_0_1_0;
      `OP_TYPE_JI: countrols = 11'b1_0_11_0_000_0_1_1;
      default:     countrols = 11'b0;
    endcase 
  end
  ...
  always_comb begin : alu_Control_signal
    case (op)
      ...
      `OP_TYPE_I: begin
        if ({funct7[5], funct3} == 4'b1101) aluControl = {funct7[5], funct3};
